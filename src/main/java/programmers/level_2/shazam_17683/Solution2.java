...
/**
 * '#'을 치환하지않고 인덱스로 복잡하게 접근하여 풀이에 실패하였다.
 */
public class Solution2 {
    ...
    public String solution(String m, String[] musicInformation) {
        ...
        for (int i = 0; i < musicInformation.length; i++) {
            ...
            hour = Integer.parseInt(endTime[0]) - Integer.parseInt(startTime[0]);
            minute = Integer.parseInt(endTime[1]) - Integer.parseInt(startTime[1]);
    ...
    public static void main(String[] args) {
        ...
        String m = "ABC";
        String[] musicInfo = {"23:50,00:00,HELLO,C#DEFGAB", "13:00,13:05,WORLD,ABCDEF"};
